...
<div id="tabs">
<ul>
<li><a href="#atlasru">Пределы систем счисления</a></li>
<li><a href="#aboutru">Подробнее о карте</a></li>
</ul>

<div id="atlasru">
## Числительные в языках Америки: пределы систем счисления
<a href="http://web-corpora.net/~agricolamz/maps/AtCauc/Numearals.Amerika.atlas/limit/numerals.america.limit.big.html"> во весь экран </a>
```{r, echo=FALSE, message=FALSE}
library(leaflet)
setwd("/home/agricolamz/_DATA/OneDrive1/_Work/Atlas.of.Caucasian.Languages/Numearals.Amerika.atlas/limit")
